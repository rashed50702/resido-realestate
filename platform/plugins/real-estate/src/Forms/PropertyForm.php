...
class PropertyForm extends FormAbstract
{
    ...
    public function buildForm()
    {
        ...
        $googleGeoApiKey = setting('google_geo_api_key', '');
        ...
        $this
            ...
            ->add('rowOpen', 'html', [
                'html' => '<div class="row"><div>' .
                    ($googleGeoApiKey ? '<button type="button" class="btn btn-danger btn-get-latitude-longitude" data-key=" ' . $googleGeoApiKey . '">Get latitude & longitude</button><br><br>' : '') .
                    '</div>',
            ])
            ->add('latitude', 'text', [
            ...
            ->addMetaBoxes([
                'type_id' => [
                    ...
                    'content' => view(
                        'plugins/real-estate::partials.form-types',
                        [
                            'types' => $types,
                            'type_id' => $typeId,
            ...
            ->add('label', 'text', [
                'label' => trans('plugins/real-estate::property.form.label'),
                'label_attr' => ['class' => 'control-label'],
                'attr' => [
                    'class' => 'form-control',
                ],
