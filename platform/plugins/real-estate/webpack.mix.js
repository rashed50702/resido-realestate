...
mix
    ...
    .js(source + '/resources/assets/js/form.js', dist + '/js')
    .copy(source + '/resources/assets/js/cropper.js', dist + '/js')
...
mix
    .sass(source + '/resources/assets/sass/app_custom.scss', dist + '/css');
